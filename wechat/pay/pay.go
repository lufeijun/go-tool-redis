...
import (
	...
	"github.com/lufeijun/go-tool-wechat/wechat/pay/order"
	"github.com/lufeijun/go-tool-wechat/wechat/pay/payconfig"
	"github.com/lufeijun/go-tool-wechat/wechat/pay/refund"
	"github.com/lufeijun/go-tool-wechat/wechat/pay/transfer"
)
...
// NewPay 实例化微信支付相关API
func NewPay(cfg *payconfig.Config) *Pay {
	return &Pay{cfg}
}
